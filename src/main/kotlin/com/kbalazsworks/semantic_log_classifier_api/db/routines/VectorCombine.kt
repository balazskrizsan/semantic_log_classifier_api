...
open class VectorCombine : AbstractRoutine<Array<Double?>>("vector_combine", Public.PUBLIC, SQLDataType.FLOAT.array()) {
    companion object {
    ...
    init {
        returnParameter = VectorCombine.RETURN_VALUE
        addInParameter(VectorCombine._1)
        addInParameter(VectorCombine._2)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: Array<Double?>?): Unit = setValue(VectorCombine._1, value)
    ...
    fun set__1(field: Field<Array<Double?>?>): Unit {
        setField(VectorCombine._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Array<Double?>?): Unit = setValue(VectorCombine._2, value)
    ...
    fun set__2(field: Field<Array<Double?>?>): Unit {
        setField(VectorCombine._2, field)
    }
}
